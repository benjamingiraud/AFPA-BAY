  ...
  <span class="pink">return</span> <span class="violet">0</span>;
    ...
    <div class="menu-container">
        ...
        <div class="menu-content">
          <ul class="menu pages">
            <li><a class="logo home " href="index.php">Home</a></li>
            <li><a class="logo cv " href="index.php?cv">CV</a></li>
            <li><a class="logo portfolio" href="index.php?portfolio">Portfolio</a> </li>
